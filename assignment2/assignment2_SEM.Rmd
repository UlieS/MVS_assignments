...
We then also added a covariance between X1 and X2 to the model which further improved the CFI (0.994) and also the RMSEA (0.15) and AIC (3475.934) decreased. The SRMR greatly decreased to a value of 0.021, surpassing the lower threshold of 0.8 which is considered to be an indicator of a good fit.
...
We compared the fit of the improved models with the given model using and with each other, which revealed that 'model3' fits the data best, while keeping the theoretical fundamentals intact.  
