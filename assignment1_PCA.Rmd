...
sum <- summary(pr.out)
plot(sum$importance[2,], xlab = "Principal Component", ylab = "Proportion of varianve explained", type = "b", main = "Variance explained", ylim = c(0,1))
...
One possible interpretation is that the drugs themselves are very similar and only the difference in the dosage leads to significantly different effects. 
