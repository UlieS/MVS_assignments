...
As it is the objective of EFA to explore the variable structure, the labeling of meaningful latent factors is ambigious. Maximum likelihood and principal factoring achieved very similar results, both generating a root mean square of the residuals (RMSR) of 0.04. This measure and the same variable groups. 
Varimax provided the better possible factor explanation as 14 variables were loading higher on the first Factor and the rest on the second. We labeled the first one including statements such as "Lack of confidence during tests" (x1),  "Heart beating fast during tests" (x18), "Screening bothers me" (x12) as "self-confidence during test situations" or "high intense anxiety" and the latent factor of variables such as "Thinking about test results" (x3), "The harder I try to contain myself, the less assured I get" (x6), "Defeat myself during tests" (x14) as "self-manipulative thoughts during test situations" or "low intense anxiety". A full structural diagram and the respective factor laodings plot can be seen below. 
